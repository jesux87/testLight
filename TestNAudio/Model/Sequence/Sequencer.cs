...
namespace TestNAudio.Model.Sequence
{
    ...
    public class LightSequence : Animatable, ILightController
    {
        ...
        public static DependencyProperty AnimatedValueProperty = DependencyProperty.Register("AnimatedValue", typeof(byte), typeof(LightSequence), new PropertyMetadata(new PropertyChangedCallback((o, args) =>
                                                                                                                                                                            {
